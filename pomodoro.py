"""
sean scully, 7-10-2025
pomodoro timer based on this kdnuggets tutorial
https://www.youtube.com/watch?v=uUWG5cm2Los

requirements:
pip install ttkbootstrap

packaging in terminal:
#Build virtual environment
python -m  venv .venv
# allow scripts to run, run environment
Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope Process
.venv\Scripts\activate
# install dependencies
pip install ttkbootstrap
pip install pyinstaller
# gui interface for pyinstaller
pip install auto-py-to-exe
# run the packger GUI
auto-py-to-exe
 - choose the script (just outside the env folder), One File, Window-based, choose icon file

creates the exe in an "output" folder
